...
Business-workflow plugins for [Claude Code](https://code.claude.com), built by [CatylAI](https://catylai.com).
...
Each plugin's README lists its commands and skills. After installing, type `/` in Claude Code to see the commands, e.g. `/hiring:job-description`.
...
Open an issue in this repository. This repo is a published release; pull requests are welcome as suggestions but changes land through CatylAI's release process.
